...
type AgentServiceConfigSpec struct {
	...
	// Foo is an example field of AgentServiceConfig. Edit agentserviceconfig_types.go to remove/update
...
// AgentServiceConfig is the Schema for the agentserviceconfigs API
